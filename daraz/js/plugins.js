...
! function (e) {
  var h, b, d = /[\.\/]/,
    ...
    k = function (a, d) {
      ...
      var f, n = b,
        ...
        L = h;
      h = a;
      for (var v = b = 0, K = H.length; K > v; v++) "zIndex" in H[v] && (E.push(H[v].zIndex), 0 > H[v].zIndex && (r[H[v].zIndex] = H[v]));
      for (E.sort(c); 0 > E[B];)
      ...
      for (v = 0; K > v; v++)
        if (f = H[v], "zIndex" in f)
          if (f.zIndex == E[B]) {
            ...
            do
              if (B++, f = r[E[B]], f && t.push(f.apply(d, e)), b) break; while (f)
          } else r[f.zIndex] = f;
  ...
  k.listeners = function (a) {
    ...
    for (h = r.length; h > a; a++) {
      ...
      for (B = t.length; B > e; e++)
        for (b = t[e].n, c = [b[r[a]], b["*"]], k = 2; k--;)(b = c[k]) && (E.push(b), L = L.concat(b.f || []));
      t = E
    }
    return L
  };
  k.on = function (b, c) {
    ...
    for (var f = b.split(d), k = n, e = 0, h = f.length; h > e; e++) k = k.n, k = k.hasOwnProperty(f[e]) && k[f[e]] || (k[f[e]] = {
      n: {}
    });
    k.f = k.f || [];
    e = 0;
    for (h = k.f.length; h > e; e++)
      if (k.f[e] == c) return a;
    return k.f.push(c),
      function (a) {
        +a == +a && (c.zIndex = +a)
  ...
  k.off = k.unbind = function (a, b) {
    if (!a) return k._events = n = {
      n: {}
    }, void 0;
    var c, e, h, H, B, E, r = a.split(d),
      t = [n];
    H = 0;
    for (B = r.length; B > H; H++)
      for (E = 0; E < t.length; E += h.length - 2) {
        if (h = [E, 1], c = t[E].n, "*" != r[H]) c[r[H]] && h.push(c[r[H]]);
        else
          for (e in c) c.hasOwnProperty(e) && h.push(c[e]);
        t.splice.apply(t, h)
      }
    H = 0;
    for (B = t.length; B > H; H++)
      for (c = t[H]; c.n;) {
        if (b) {
          ...
          for (e in delete c.f, c.n) c.n.hasOwnProperty(e) && c.n[e].f && delete c.n[e].f;
        c = c.n
      }
  };
  k.once = function (a, b) {
...
(function (e, h) {
  ...
  var b = function (a) {
      var b = {},
        d = e.requestAnimationFrame || e.webkitRequestAnimationFrame || e.mozRequestAnimationFrame || e.oRequestAnimationFrame || e.msRequestAnimationFrame || function (a) {
          setTimeout(a, 16)
        },
        ...
        u = function (a) {
          return null == a ? this.dur : (this.s = this.s * a / this.dur, this.dur = a, void 0)
        },
        H = function () {
          delete b[this.id];
        ...
        E = function () {
          this.pdif && (this.b = this.get() - this.pdif, delete this.pdif, b[this.id] = this)
        },
        r = function () {
          var f = 0,
            e;
          for (e in b)
            if (b.hasOwnProperty(e)) {
              var h, m = b[e];
              h = m.get();
              if (f++, m.s = (h - m.b) / (m.dur / m.spd), 1 <= m.s && (delete b[e], m.s = 1, f--, function (b) {
                  setTimeout(function () {
                    a("mina.finish." + b.id, b)
                  })
                }(m)), k(m.start)) {
                h = [];
                for (var p = 0, q = m.start.length; q > p; p++) h[p] = +m.start[p] + (m.end[p] - m.start[p]) * m.easing(m.s)
        ...
        t = function (a, k, e, I, w, T, C) {
          ...
          k = 0;
          for (X in b)
            if (b.hasOwnProperty(X) && (k++, 2 == k)) break;
          return 1 == k && d(r), a
        };
      return t.time = Date.now || function () {
        ...
        var b;
        return 1 / 2.75 > a ? b = 7.5625 * a * a : 2 / 2.75 > a ? (a -= 1.5 / 2.75, b = 7.5625 * a * a + .75) : 2.5 / 2.75 > a ? (a -= 2.25 / 2.75, b = 7.5625 * a * a + .9375) : (a -= 2.625 / 2.75, b = 7.5625 * a * a + .984375), b
      }, e.mina = t, t
    ...
    d = function () {
      function a(a, b) {
        ...
        return a = null == a ? "100%" : a, b = null == b ? "100%" : b, new T(a, b)
      }

      function c(a, b) {
        if (b) {
          if ("string" == typeof a && (a = c(a)), "string" == typeof b) return "xlink:" == b.substring(0, 6) ? a.getAttributeNS(ua, b.substring(6)) : "xml:" == b.substring(0, 4) ? a.getAttributeNS(oa, b.substring(4)) : a.getAttribute(b);
          for (var d in b)
            if (b[P](d)) {
              var x = D(b[d]);
              x ? "xlink:" == d.substring(0, 6) ? a.setAttributeNS(ua, d.substring(6), x) : "xml:" == d.substring(0, 4) ? a.setAttributeNS(oa, d.substring(4), x) : a.setAttribute(d, x) : a.removeAttribute(d)
            }
      ...
      function d(a, b) {
        return b = D.prototype.toLowerCase.call(b), "finite" == b ? isFinite(a) : "array" == b && (a instanceof Array || Array.isArray && Array.isArray(a)) ? !0 : "null" == b && null === a || b == typeof a && null !== a || "object" == b && a === Object(a) || ea.call(a).slice(8, -1).toLowerCase() == b
      }
      ...
      function p(a, b, d) {
        function x() {
          ...
          else l = (1E3 <= F.length && delete f[F.shift()], F.push(l), f[l] = a.apply(b, c), d ? d(f[l]) : f[l]);
          return l
        }
        return x
      }
      ...
      function m(a, b, d, x, c, l) {
        return null == c ? (a -= d, b -= x, a || b ? (180 * J.atan2(-b, -a) / fa + 540) % 360 : 0) : m(a, b, c, l) - m(d, x, c, l)
      }
      ...
      function u(a, b, d, x, c, l) {
        return null == b && "[object SVGMatrix]" == ea.call(a) ? (this.a = a.a, this.b = a.b, this.c = a.c, this.d = a.d, this.e = a.e, this.f = a.f, void 0) : (null != a ? (this.a = +a, this.b = +b, this.c = +d, this.d = +x, this.e = +c, this.f = +l) : (this.a = 1, this.b = 0, this.c = 0, this.d = 1, this.e = 0, this.f = 0), void 0)
      }

      function H(a) {
        var b = [];
        return a = a.replace(/(?:^|\s)(\w+)\(([^)]+)\)/g, function (a, z, d) {
          return d = d.split(/\s*,\s*|\s+/), "rotate" == z && 1 == d.length && d.push(0, 0), "scale" == z && (2 == d.length && d.push(0, 0), 1 == d.length && d.push(d[0], 0, 0)), "skewX" == z ? b.push(["m", 1, 0, J.tan(f(d[0])), 1, 0, 0]) : "skewY" == z ? b.push(["m", 1, J.tan(f(d[0])), 0, 1, 0, 0]) : b.push([z.charAt(0)].concat(d)), a
        }), b
      }
        ...
        if (d)
          for (var c = 0, l = d.length; l > c; c++) {
            var f, F, A, n, k, e = d[c],
              ...
              m = e[0] != h,
              Q = m ? x.invert() : 0;
            "t" == h && 2 == y ? x.translate(e[1], 0) : "t" == h && 3 == y ? m ? (f = Q.x(0, 0), F = Q.y(0, 0), A = Q.x(e[1], e[2]), n = Q.y(e[1], e[2]), x.translate(A - f, n - F)) : x.translate(e[1], e[2]) : "r" == h ? 2 == y ? (k = k || b, x.rotate(e[1], k.x + k.width / 2, k.y + k.height / 2)) : 4 == y && (m ? (A = Q.x(e[2], e[3]), n = Q.y(e[2], e[3]), x.rotate(e[1], A, n)) : x.rotate(e[1], e[2], e[3])) : "s" == h ? 2 == y || 3 == y ? (k = k || b, x.scale(e[1], e[y - 1], k.x + k.width / 2, k.y + k.height / 2)) : 4 == y ? m ? (A = Q.x(e[2], e[3]), n = Q.y(e[2], e[3]), x.scale(e[1], e[1], A, n)) : x.scale(e[1], e[1], e[2], e[3]) : 5 == y && (m ? (A = Q.x(e[3], e[4]), n = Q.y(e[3], e[4]), x.scale(e[1], e[2], A, n)) : x.scale(e[1], e[2], e[3], e[4])) : "m" == h && 7 == y && x.add(e[1], e[2], e[3], e[4], e[5], e[6])
          }
        return x
      }
      ...
      function E(z, b) {
        if (null == b) {
          var c = !0;
          if (b = "linearGradient" == z.type || "radialGradient" == z.type ? z.node.getAttribute("gradientTransform") : "pattern" == z.type ? z.node.getAttribute("patternTransform") : z.node.getAttribute("transform"), !b) return new u;
          b = H(b)
        } else b = a._.rgTransform.test(b) ? D(b).replace(/\.{3}|\u2026/g, z._.transform || R) : H(b), d(b, "array") && (b = a.path ? a.path.toString.call(b) : D(b)), z._.transform = b;
      ...
      function r(z) {
        ...
        z = z.node.ownerSVGElement && C(z.node.ownerSVGElement) || z.node.parentNode && C(z.node.parentNode) || a.select("svg") || a(0, 0);
        b = z.select("defs");
        b = null == b ? !1 : b.node;
      ...
      function t(a, b, d) {
        ...
        function f(x, c) {
          null == b ? F[x] = c(a.attr(x)) : x == b && (F = c(null == d ? a.attr(x) : d))
        }
        var e = r(a),
          F = {},
          A = e.querySelector(".svg---mgr");
        switch (A || (A = c("rect"), c(A, {
          width: 10,
          height: 10,
          "class": "svg---mgr"
        }), e.appendChild(A)), a.type) {
          case "rect":
            f("rx", x), f("ry", l);
          case "image":
      ...
      function L(a) {
        ...
        for (var l = x.childNodes, b = 0; b < l.length; b++) this[c++] = C(l[b]);
        return this
      }
      ...
      function v(a) {
        ...
        if (this.node = a, b && (this.paper = new T(b)), this.type = a.tagName, this.anims = {}, this._ = {
            transform: []
          }, a.snap = d, pa[d] = this, "g" == this.type) {
          this.add = L;
          for (var c in T.prototype) T.prototype[P](c) && (this[c] = T.prototype[c])
        }
      }
      ...
      function T(a, b) {
        var d, x, l, f = T.prototype;
        if (a && "svg" == a.tagName) {
          if (a.snap in pa) return pa[a.snap];
          d = new v(a);
          x = a.getElementsByTagName("desc")[0];
          l = a.getElementsByTagName("defs")[0];
          x || (x = c("desc"), x.appendChild(M.doc.createTextNode("AMR")), d.node.appendChild(x));
          l || (l = c("defs"), d.node.appendChild(l));
          d.defs = l;
          for (var e in f) f[P](e) && (d[e] = f[e]);
          d.paper = d.root = d
        } else d = w("svg", M.doc.body), c(d.node, {
          height: b,
          version: 1.1,
          width: a,
          xmlns: oa
      ...
      function C(a) {
        return a ? a instanceof v || a instanceof I ? a : "svg" == a.tagName ? new T(a) : new v(a) : a
      }
      ...
      function N(b, d) {
        ...
        return b = a.color(b), x["stop-color"] = b.hex, 1 > b.opacity && (x["stop-opacity"] = b.opacity), c(l, x), this.node.appendChild(l), this
      }
      ...
      function S(a, b) {
        function d(a, b) {
          for (var z = (b - e) / (a - F), c = F; a > c; c++) f[c].offset = +(+e + z * (c - F)).toFixed(2);
          F = a;
          e = b
        }
        var x, l = K(h("snap.util.grad.parse", null, b));
        if (!l) return null;
        l.params.unshift(a);
        x = "l" == l.type.toLowerCase() ? aa.apply(0, l.params) : ha.apply(0, l.params);
        l.type != l.type.toLowerCase() && c(x.node, {
      ...
      function aa(a, b, d, l, f) {
        ...
        return a.stops = X, a.addStop = N, a.getBBox = G, null != b && c(a.node, {
          x1: b,
          y1: d,
          x2: l,
          y2: f
      ...
      function U(b) {
        return function (d) {
          if (h.stop(), d instanceof I && 1 == d.node.childNodes.length && ("radialGradient" == d.node.firstChild.tagName || "linearGradient" == d.node.firstChild.tagName || "pattern" == d.node.firstChild.tagName) && (d = d.node.firstChild, r(this).appendChild(d), d = C(d)), d instanceof v)
      ...
      function ca(a) {
        ...
        for (var d = 0, l = a.length; l > d; d++) {
          ...
          "tspan" == c.tagName && (1 == c.childNodes.length && 3 == c.firstChild.nodeType ? b.push(c.firstChild.nodeValue) : b.push(ca(c)))
        }
        return b
      }
      a.version = "0.2.0";
      ...
      a.format = function () {
        var a = /\{([^\}]+)\}/g,
          ...
          d = function (a, d, z) {
            var c = z;
            return d.replace(b, function (a, b, d, z, l) {
              b = b || z;
              c && (b in c && (c = c[b]), "function" == typeof c && l && (c = c()))
            }), c = (null == c || c == z ? a : c) + ""
          };
        return function (b, c) {
      ...
      (function (a) {
        ...
        a.add = function (a, b, d, z, c, l) {
          ...
          return this.a = da[0][0], this.b = da[1][0], this.c = da[0][1], this.d = da[1][1], this.e = da[0][2], this.f = da[1][2], this
        };
        a.invert = function () {
          var a = this.a * this.d - this.b * this.c;
          return new u(this.d / a, -this.b / a, -this.c / a, this.a / a, (this.c * this.f - this.d * this.e) / a, (this.b * this.e - this.a * this.f) / a)
        };
        a.clone = function () {
        ...
        a.scale = function (a, b, d, z) {
          return null == b && (b = a), (d || z) && this.add(1, 0, 0, 1, d, z), this.add(a, 0, 0, b, 0, 0), (d || z) && this.add(1, 0, 0, 1, -d, -z), this
        };
        ...
        a.split = function () {
          ...
          var c = -z[0][1],
            z = z[1][1];
          return 0 > z ? (a.rotate = q(J.acos(z)), 0 > c && (a.rotate = 360 - a.rotate)) : a.rotate = q(J.asin(c)), a.isSimple = !(+a.shear.toFixed(9) || a.scalex.toFixed(9) != a.scaley.toFixed(9) && a.rotate), a.isSuperSimple = !+a.shear.toFixed(9) && a.scalex.toFixed(9) == a.scaley.toFixed(9) && !a.rotate, a.noRotation = !+a.shear.toFixed(9) && !a.rotate, a
        };
        a.toTransformString = function (a) {
          a = a || this.split();
          return a.isSimple ? (a.scalex = +a.scalex.toFixed(4), a.scaley = +a.scaley.toFixed(4), a.rotate = +a.rotate.toFixed(4), (a.dx || a.dy ? "t" + [+a.dx.toFixed(4), +a.dy.toFixed(4)] : R) + (1 != a.scalex || 1 != a.scaley ? "s" + [a.scalex, a.scaley, 0, 0] : R) + (a.rotate ? "r" + [+a.rotate.toFixed(4), 0, 0] : R)) : "m" + [this.get(0), this.get(1), this.get(2), this.get(3), this.get(4), this.get(5)]
        }
      })(u.prototype);
      a.Matrix = u;
      a.getRGB = p(function (b) {
        if (!b || (b = D(b)).indexOf("-") + 1) return {
          r: -1,
          g: -1,
          b: -1,
          hex: "none",
        ...
        if (!(ga[P](b.toLowerCase().substring(0, 2)) || "#" == b.charAt()) && (b = sa(b)), !b) return {
          r: -1,
          g: -1,
          b: -1,
          hex: "none",
        ...
        var c, f, e, k, y, h;
        return (b = b.match(l)) ? (b[2] && (e = W(b[2].substring(5), 16), f = W(b[2].substring(3, 5), 16), c = W(b[2].substring(1, 3), 16)), b[3] && (e = W((y = b[3].charAt(3)) + y, 16), f = W((y = b[3].charAt(2)) + y, 16), c = W((y = b[3].charAt(1)) + y, 16)), b[4] && (h = b[4].split(A), c = O(h[0]), "%" == h[0].slice(-1) && (c *= 2.55), f = O(h[1]), "%" == h[1].slice(-1) && (f *= 2.55), e = O(h[2]), "%" == h[2].slice(-1) && (e *= 2.55), "rgba" == b[1].toLowerCase().slice(0, 4) && (k = O(h[3])), h[3] && "%" == h[3].slice(-1) && (k /= 100)), b[5] ? (h = b[5].split(A), c = O(h[0]), "%" == h[0].slice(-1) && (c /= 100), f = O(h[1]), "%" == h[1].slice(-1) && (f /= 100), e = O(h[2]), "%" == h[2].slice(-1) && (e /= 100), ("deg" == h[0].slice(-3) || "\u00b0" == h[0].slice(-1)) && (c /= 360), "hsba" == b[1].toLowerCase().slice(0, 4) && (k = O(h[3])), h[3] && "%" == h[3].slice(-1) && (k /= 100), a.hsb2rgb(c, f, e, k)) : b[6] ? (h = b[6].split(A), c = O(h[0]), "%" == h[0].slice(-1) && (c /= 100), f = O(h[1]), "%" == h[1].slice(-1) && (f /= 100), e = O(h[2]), "%" == h[2].slice(-1) && (e /= 100), ("deg" == h[0].slice(-3) || "\u00b0" == h[0].slice(-1)) && (c /= 360), "hsla" == b[1].toLowerCase().slice(0, 4) && (k = O(h[3])), h[3] && "%" == h[3].slice(-1) && (k /= 100), a.hsl2rgb(c, f, e, k)) : (c = Y(J.round(c), 255), f = Y(J.round(f), 255), e = Y(J.round(e), 255), k = Y(V(k, 0), 1), b = {
          r: c,
          g: f,
          b: e,
          toString: ma
        }, b.hex = "#" + (16777216 | e | f << 8 | c << 16).toString(16).slice(1), b.opacity = d(k, "finite") ? k : 1, b)) : {
          r: -1,
          g: -1,
          b: -1,
          hex: "none",
      ...
      var sa = function (a) {
          ...
          return sa = p(function (a) {
            if ("red" == a.toLowerCase()) return "rgb(255, 0, 0)";
            b.style.color = "rgb(255, 0, 0)";
            b.style.color = a;
            a = M.doc.defaultView.getComputedStyle(b, R).getPropertyValue("color");
        ...
        wa = function (b, c, l) {
          if (null == c && d(b, "object") && "r" in b && "g" in b && "b" in b && (l = b.b, c = b.g, b = b.r), null == c && d(b, string)) l = a.getRGB(b), b = l.r, c = l.g, l = l.b;
          return (1 < b || 1 < c || 1 < l) && (b /= 255, c /= 255, l /= 255), [b, c, l]
        },
        xa = function (b, c, l, f) {
          b = J.round(255 * b);
          c = J.round(255 * c);
      ...
      a.color = function (b) {
        var c;
        return d(b, "object") && "h" in b && "s" in b && "b" in b ? (c = a.hsb2rgb(b), b.r = c.r, b.g = c.g, b.b = c.b, b.opacity = 1, b.hex = c.hex) : d(b, "object") && "h" in b && "s" in b && "l" in b ? (c = a.hsl2rgb(b), b.r = c.r, b.g = c.g, b.b = c.b, b.opacity = 1, b.hex = c.hex) : (d(b, "string") && (b = a.getRGB(b)), d(b, "object") && "r" in b && "g" in b && "b" in b && !("error" in b) ? (c = a.rgb2hsl(b), b.h = c.h, b.s = c.s, b.l = c.l, c = a.rgb2hsb(b), b.v = c.b) : (b = {
          hex: "none"
        }, b.r = b.g = b.b = b.h = b.s = b.v = b.l = -1, b.error = 1)), b.toString = ma, b
      };
      a.hsb2rgb = function (a, b, c, l) {
        d(a, "object") && "h" in a && "s" in a && "b" in a && (c = a.b, b = a.s, a = a.h, l = a.o);
        a *= 360;
        var f, e, A, F, k;
        return a = a % 360 / 60, k = c * b, F = k * (1 - ba(a % 2 - 1)), f = e = A = c - k, a = ~~a, f += [k, F, 0, 0, F, k][a], e += [F, k, k, F, 0, 0][a], A += [0, 0, F, k, k, F][a], xa(f, e, A, l)
      };
      a.hsl2rgb = function (a, b, c, l) {
        d(a, "object") && "h" in a && "s" in a && "l" in a && (c = a.l, b = a.s, a = a.h);
        (1 < a || 1 < b || 1 < c) && (a /= 360, b /= 100, c /= 100);
        a *= 360;
        var f, e, A, F, k;
        return a = a % 360 / 60, k = 2 * b * (.5 > c ? c : 1 - c), F = k * (1 - ba(a % 2 - 1)), f = e = A = c - k / 2, a = ~~a, f += [k, F, 0, 0, F, k][a], e += [F, k, k, F, 0, 0][a], A += [0, 0, F, k, k, F][a], xa(f, e, A, l)
      };
      a.rgb2hsb = function (a, b, c) {
        ...
        c = c[2];
        var d, l, f, e;
        return f = V(a, b, c), e = f - Y(a, b, c), d = 0 == e ? null : f == a ? (b - c) / e : f == b ? (c - a) / e + 2 : (a - b) / e + 4, d = (d + 360) % 6 * 60 / 360, l = 0 == e ? 0 : e / f, {
          h: d,
          s: l,
          b: f,
          toString: ta
      ...
      a.rgb2hsl = function (a, b, c) {
        ...
        c = c[2];
        var d, l, f, e, F, A;
        return e = V(a, b, c), F = Y(a, b, c), A = e - F, d = 0 == A ? null : e == a ? (b - c) / A : e == b ? (c - a) / A + 2 : (a - b) / A + 4, d = (d + 360) % 6 * 60 / 360, f = (e + F) / 2, l = 0 == A ? 0 : .5 > f ? A / (2 * f) : A / (2 - 2 * f), {
          h: d,
          s: l,
          l: f,
          toString: Ea
      ...
      a.parsePathString = function (b) {
        ...
        var l = {
          ...
          f = [];
        return d(b, "array") && d(b[0], "array") && (f = a.path.clone(b)), f.length || D(b).replace(ra, function (a, b, c) {
          var d = [];
          a = b.toLowerCase();
          if (c.replace(va, function (a, b) {
              b && d.push(+b)
            }), "m" == a && 2 < d.length && (f.push([b].concat(d.splice(0, 2))), a = "l", b = "m" == b ? "l" : "L"), "o" == a && 1 == d.length && f.push([b, d[0]]), "r" == a) f.push([b].concat(d));
          else
            for (; d.length >= l[a] && (f.push([b].concat(d.splice(0, l[a]))), l[a]););
        }), f.toString = a.path.toString, c.arr = a.path.clone(f), f
      };
      var za = a.parseTransformString = function (b) {
        if (!b) return null;
        var c = [];
        return d(b, "array") && d(b[0], "array") && (c = a.path.clone(b)), c.length || D(b).replace(Ba, function (a, b, d) {
          var l = [];
          b.toLowerCase();
          ...
          c.push([b].concat(l))
        }), c.toString = a.path.toString, c
      };
      a._.svgTransform2string = H;
      a._.rgTransform = RegExp("^[a-z][  \n\x0B\f\r \u00a0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*-?\\.?\\d", "i");
      a._.transform2matrix = B;
      a._unit2px = t;
      var Aa = M.doc.contains || M.doc.compareDocumentPosition ? function (a, b) {
      ...
      (function (l) {
        function f(a) {
          function b(a, d) {
            var l = c(a.node, d);
            (l = (l = l && l.match(A)) && l[2]) && "#" == l.charAt() && (l = l.substring(1), l && (k[l] = (k[l] || []).concat(function (b) {
              var l = {};
              l[d] = na(b);
              c(a.node, l)
            })))
          ...
          function d(a) {
            ...
            b && "#" == b.charAt() && (b = b.substring(1), b && (k[b] = (k[b] || []).concat(function (b) {
              a.attr("xlink:href", "#" + b)
            })))
          }
          var l, e = a.selectAll("*"),
        ...
        function A(a) {
          return function () {
            ...
            if (a)
              for (var l = 0, f = c.length; f > l; l++) b += " " + c[l].name + '="' + c[l].value.replace(/"/g, '\\"') + '"';
            if (d.length) {
              a && (b += ">");
              l = 0;
              for (f = d.length; f > l; l++) 3 == d[l].nodeType ? b += d[l].nodeValue : 1 == d[l].nodeType && (b += C(d[l]).toString());
              a && (b += "</" + this.type + ">")
            } else a && (b += "/>");
            return b
          }
        ...
        l.attr = function (a, b) {
          ...
          if (d(a, "string")) {
            if (!(1 < arguments.length)) return K(h("snap.util.getattr." + a, this));
            var c = {};
            c[a] = b;
            a = c
          }
        ...
        l.getBBox = function (b) {
          ...
          var d = c._;
          return b ? (d.bboxwt = a.path.get[c.type] ? a.path.getBBox(c.realPath = a.path.get[c.type](c)) : a._.box(c.node.getBBox()), a._.box(d.bboxwt)) : (c.realPath = (a.path.get[c.type] || a.path.get.deflt)(c), d.bbox = a.path.getBBox(a.path.map(c.realPath, c.matrix)), a._.box(d.bbox))
        };
        var k = function () {
          return this.string
        };
        l.transform = function (a) {
          ...
          return a instanceof u && (a = a.toTransformString()), E(this, a), this.node && ("linearGradient" == this.type || "radialGradient" == this.type ? c(this.node, {
        ...
        l.use = function () {
          ...
          return b || (b = this.id, c(this.node, {
            id: b
          })), a = "linearGradient" == this.type || "radialGradient" == this.type || "pattern" == this.type ? w(this.type, this.node.parentNode) : w("use", this.node.parentNode), c(a.node, {
            "xlink:href": "#" + b
          }), a.original = this, a
        };
        l.clone = function () {
          var a = C(this.node.cloneNode(!0));
          return c(a.node, "id") && c(a.node, {
            id: a.id
          }), f(a), a.insertAfter(this), a
        };
        l.toDefs = function () {
        ...
        l.pattern = function (a, b, l, f) {
          ...
          return null == a && (a = this.getBBox()), d(a, "object") && "x" in a && (b = a.y, l = a.width, f = a.height, a = a.x), c(e.node, {
            x: a,
            y: b,
            width: l,
            height: f,
        ...
        l.marker = function (a, b, l, f, e, A) {
          ...
          return null == a && (a = this.getBBox()), d(a, "object") && "x" in a && (b = a.y, l = a.width, f = a.height, e = a.refX || a.cx, A = a.refY || a.cy, a = a.x), c(z.node, {
            viewBox: [a, b, l, f].join(" "),
            markerWidth: l,
            markerHeight: f,
            orient: "auto",
            ...
            refY: A || 0,
            id: z.id
          }), z.node.appendChild(this.node), z
        };
        ...
        l.inAnim = function () {
          var a = [],
            b;
          for (b in this.anims) this.anims[P](b) && ! function (b) {
            a.push({
        ...
        l.animate = function (a, c, l, f) {
          ...
          a instanceof y && (f = a.callback, l = a.easing, c = l.dur, a = a.attr);
          var A, z, k, da, Q = [],
            m = [],
            x = {},
            ga = this,
          ...
          for (ia in a)
            if (a[P](ia)) {
              ga.equal ? (da = ga.equal(ia, D(a[ia])), A = da.from, z = da.to, k = da.f) : (A = +ga.attr(ia), z = +a[ia]);
              var ra = d(A, "array") ? A.length : 1;
              x[ia] = e(Q.length, Q.length + ra, k);
              Q = Q.concat(A);
              m = m.concat(z)
            } A = b.time();
          var p = b(Q, m, A, A + c, b.time, function (a) {
            var b = {},
              c;
            for (c in x) x[P](c) && (b[c] = x[c](a));
            ga.attr(b)
          }, l);
          return ga.anims[p.id] = p, p._attrs = a, p._callback = f, h.once("mina.finish." + p.id, function () {
        ...
        l.data = function (b, c) {
          ...
          if (0 == arguments.length) return h("snap.data.get." + this.id, this, d, null), d;
        ...
        l.removeData = function (a) {
          return null == a ? Q[this.id] = {} : Q[this.id] && delete Q[this.id][a], this
        };
      ...
      a.parse = function (a) {
        ...
        if (a = D(a), a.match(/^\s*<\s*svg(?:\s|>)/) || (a = "<svg>" + a + "</svg>", c = !1), d.innerHTML = a, a = d.getElementsByTagName("svg")[0])
          if (c) b = a;
          else
      ...
      a.fragment = function () {
        for (var b = Array.prototype.slice.call(arguments, 0), c = M.doc.createDocumentFragment(), d = 0, l = b.length; l > d; d++) {
          var f = b[d];
      ...
      (function (a) {
        ...
        a.rect = function (a, b, c, l, f, e) {
          var A;
          return null == e && (e = f), d(a, "object") && "x" in a ? A = a : null != a && (A = {
            x: a,
            y: b,
            width: c,
            height: l
          }, null != f && (A.rx = f, A.ry = e)), this.el("rect", A)
        };
        a.circle = function (a, b, c) {
          var l;
          return d(a, "object") && "cx" in a ? l = a : null != a && (l = {
            cx: a,
            cy: b,
            r: c
          }), this.el("circle", l)
        ...
        a.image = function (a, b, l, f, e) {
          ...
          if (d(a, "object") && "src" in a) A.attr(a);
            ...
            null != f && null != e ? (k.width = f, k.height = e) : Da(a, function () {
              c(A.node, {
        ...
        a.ellipse = function (a, b, c, l) {
          ...
          return d(a, "object") && "cx" in a ? f.attr(a) : null != a && f.attr({
            cx: a,
            cy: b,
            rx: c,
            ry: l
        ...
        a.path = function (a) {
          ...
          return d(a, "object") && !d(a, "array") ? b.attr(a) : a && b.attr({
            d: a
          }), b
        };
        ...
        a.text = function (a, b, c) {
          ...
          return d(a, "object") ? l.attr(a) : null != a && l.attr({
            x: a,
            y: b,
            text: c || ""
          }), l
        ...
        a.line = function (a, b, c, l) {
          ...
          return d(a, "object") ? f.attr(a) : null != a && f.attr({
            x1: a,
            x2: c,
            y1: b,
            y2: l
        ...
        a.polyline = function (a) {
          ...
          return d(a, "object") && !d(a, "array") ? b.attr(a) : null != a && b.attr({
            points: a
          }), b
        };
        ...
        (function () {
          ...
          a.toString = function () {
            var a, b = M.doc.createDocumentFragment(),
              d = M.doc.createElement("div"),
              l = this.node.cloneNode(!0);
            return b.appendChild(d), d.appendChild(l), c(l, {
              xmlns: oa
            }), a = d.innerHTML, b.removeChild(b.firstChild), a
          };
          a.clear = function () {
      ...
      a.ajax = function (a, b, c, l) {
        ...
        if (f) {
          if (d(b, "function")) l = c, c = b, b = null;
            ...
            var A = [],
              k;
            for (k in b) b.hasOwnProperty(k) && A.push(encodeURIComponent(k) + "=" + encodeURIComponent(b[k]));
            b = A.join("&")
          }
          return f.open(b ? "POST" : "GET", a, !0), f.setRequestHeader("X-Requested-With", "XMLHttpRequest"), b && f.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), c && (h.once("snap.ajax." + e + ".0", c), h.once("snap.ajax." + e + ".200", c), h.once("snap.ajax." + e + ".304", c)), f.onreadystatechange = function () {
      ...
      h.on("snap.util.attr.mask", function (a) {
        if (a instanceof v || a instanceof I) {
          if (h.stop(), a instanceof I && 1 == a.node.childNodes.length && (a = a.node.firstChild, r(this).appendChild(a), a = C(a)), "mask" == a.type) var b = a;
          else b = w("mask", r(this)), b.node.appendChild(a.node), !b.node.id && c(b.node, {
            id: b.id
          });
          c(this.node, {
            mask: na(b.id)
      ...
      (function (a) {
        ...
        if (a instanceof v || a instanceof I) {
          ...
          else b = w("clipPath", r(this)), b.node.appendChild(a.node), !b.node.id && c(b.node, {
            id: b.id
          });
          c(this.node, {
            "clip-path": na(b.id)
      ...
      h.on("snap.util.attr.#text", function (a) {
        h.stop();
        a = D(a);
        for (a = M.doc.createTextNode(a); this.node.firstChild;) this.node.removeChild(this.node.firstChild);
      ...
      h.on("snap.util.attr.viewBox", function (a) {
        a = d(a, "object") && "x" in a ? [a.x, a.y, a.width, a.height].join(" ") : d(a, "array") ? a.join(" ") : a;
        c(this.node, {
          viewBox: a
        });
        h.stop()
      ...
      h.on("snap.util.attr.r", function (a) {
        "rect" == this.type && (h.stop(), c(this.node, {
          rx: a,
          ry: a
        }))
      })(-1);
      h.on("snap.util.attr.textpath", function (a) {
        if (h.stop(), "text" == this.type) {
          var b, l;
          if (!a && this.textPath) {
            for (l = this.textPath; l.node.firstChild;) this.node.appendChild(l.node.firstChild);
            return l.remove(), delete this.textPath, void 0
          }
          d(a, "string") ? (b = r(this), a = C(b.parentNode).path(a), b.appendChild(a.node), b = a.id, a.attr({
            id: b
          })) : (a = C(a), a instanceof v && (b = a.attr("id"), b || (b = a.id, a.attr({
            id: b
          }))));
          if (b)
            if (l = this.textPath, a = this.node, l) l.attr({
              "xlink:href": "#" + b
            });
            else {
              for (l = c("textPath", {
                  "xlink:href": "#" + b
                }); a.firstChild;) l.appendChild(a.firstChild);
              a.appendChild(l);
              this.textPath = C(l)
            }
        }
      ...
      h.on("snap.util.attr.text", function (a) {
        if ("text" == this.type) {
          for (var b = this.node, l = function (a) {
              var b = c("tspan");
              if (d(a, "array"))
      ...
      (function () {
        function b(c) {
          return function () {
            h.stop();
            var b = M.doc.defaultView.getComputedStyle(this.node, null).getPropertyValue("marker-" + c);
      ...
      h.on("snap.util.getattr.r", function () {
        return "rect" == this.type && c(this.node, "rx") == c(this.node, "ry") ? (h.stop(), c(this.node, "rx")) : void 0
      })(-1);
      ...
      h.on("snap.util.getattr", function () {
        ...
        return ya[P](b) ? M.doc.defaultView.getComputedStyle(this.node, null).getPropertyValue(b) : c(this.node, a)
      });
      return a.getElementByPoint = function (a, b) {
        var c, d, l = (this.canvas, M.doc.elementFromPoint(a, b));
        if (M.win.opera && "svg" == l.tagName) {
          ...
          var f = c.body,
            e = c.documentElement;
          c = d.top + (g.win.pageYOffset || e.scrollTop || f.scrollTop) - (e.clientTop || f.clientTop || 0);
          d = d.left + (g.win.pageXOffset || e.scrollLeft || f.scrollLeft) - (e.clientLeft || f.clientLeft || 0);
          f = l.createSVGRect();
          f.x = a - d;
          f.y = b - c;
          f.width = f.height = 1;
  ...
  return d.plugin(function (a, b) {
    function d(a) {
      ...
      return b[a] ? b[a].sleep = 100 : b[a] = {
        ...
        for (var c in b) b[ca](c) && c != a && (b[c].sleep--, !b[c].sleep && delete b[c])
      }), b[a]
    }
    ...
    function f(a, b, c, d, f, e, k, h, n) {
      if (null == n) a = r(a, b, c, d, f, e, k, h);
        ...
        if (0 > n || r(a, b, c, d, f, e, k, h) < n) n = void 0;
          ...
          var m, p = .5,
            q = 1 - p;
          for (m = r(a, b, c, d, f, e, k, h, q); .01 < Y(m - n);) p /= 2, q += (n > m ? 1 : -1) * p, m = r(a, b, c, d, f, e, k, h, q);
          n = q
        }
    ...
    function q(d, e) {
      ...
      return a._.cacher(function (a, h, n) {
        a instanceof b && (a = a.attr("d"));
        a = G(a);
        for (var m, p, y, q, Z, t = "", r = {}, w = 0, I = 0, v = a.length; v > I; I++) {
          if (y = a[I], "M" == y[0]) m = +y[1], p = +y[2];
          else {
            if (q = f(m, p, y[1], y[2], y[3], y[4], y[5], y[6]), w + q > h) {
              if (e && !r.start) {
                if (Z = f(m, p, y[1], y[2], y[3], y[4], y[5], y[6], h - w), t += ["C" + k(Z.start.x), k(Z.start.y), k(Z.m.x), k(Z.m.y), k(Z.x), k(Z.y)], n) return t;
                r.start = t;
                t = ["M" + k(Z.x), k(Z.y) + "C" + k(Z.n.x), k(Z.n.y), k(Z.end.x), k(Z.end.y), k(y[5]), k(y[6])].join();
                w += q;
                m = +y[5];
                p = +y[6];
                continue
              }
              if (!d && !e) return f(m, p, y[1], y[2], y[3], y[4], y[5], y[6], h - w)
            }
            w += q;
            m = +y[5];
            p = +y[6]
        ...
        return r.end = t, d ? w : e ? r : u(m, p, y[0], y[1], y[2], y[3], y[4], y[5], 1)
      }, null, a._.clone)
    }
    ...
    function E(a, b) {
      return a = e(a), b = e(b), B(b, a.x, a.y) || B(b, a.x2, a.y) || B(b, a.x, a.y2) || B(b, a.x2, a.y2) || B(a, b.x, b.y) || B(a, b.x2, b.y) || B(a, b.x, b.y2) || B(a, b.x2, b.y2) || (a.x < b.x2 && a.x > b.x || b.x < a.x2 && b.x > a.x) && (a.y < b.y2 && a.y > b.y || b.y < a.y2 && b.y > a.y)
    }

    function r(a, b, c, d, f, e, k, h, n) {
      null == n && (n = 1);
      n = (1 < n ? 1 : 0 > n ? 0 : n) / 2;
      for (var m = [-.1252, .1252, -.3678, .3678, -.5873, .5873, -.7699, .7699, -.9041, .9041, -.9816, .9816], p = [.2491, .2491, .2335, .2335, .2032, .2032, .1601, .1601, .1069, .1069, .0472, .0472], q = 0, t = 0; 12 > t; t++) var r = n * m[t] + n,
        G = r * (r * (-3 * a + 9 * c - 9 * f + 3 * k) + 6 * a - 12 * c + 6 * f) - 3 * a + 3 * c,
        r = r * (r * (-3 * b + 9 * d - 9 * e + 3 * h) + 6 * b - 12 * d + 6 * e) - 3 * b + 3 * d,
    ...
    function t(a, b, c) {
      a = G(a);
      b = G(b);
      for (var d, f, e, k, n, h, m, p, q, t, w = c ? 0 : [], I = 0, v = a.length; v > I; I++) {
        var S = a[I];
        if ("M" == S[0]) d = n = S[1], f = h = S[2];
        else {
          "C" == S[0] ? (q = [d, f].concat(S.slice(1)), d = q[6], f = q[7]) : (q = [d, f, d, f, n, h, n, h], d = n, f = h);
          for (var S = 0, ta = b.length; ta > S; S++) {
            var C = b[S];
            if ("M" == C[0]) e = m = C[1], k = p = C[2];
            else {
              "C" == C[0] ? (t = [e, k].concat(C.slice(1)), e = t[6], k = t[7]) : (t = [e, k, e, k, m, p, m, p], e = m, k = p);
              var aa = q,
                B = t,
                C = c,
                D = H(aa),
                L = H(B);
              if (E(D, L)) {
                for (var D = r.apply(0, aa), L = r.apply(0, B), D = ~~(D / 5), L = ~~(L / 5), T = [], ha = [], K = {}, z = C ? 0 : [], U = 0; D + 1 > U; U++) {
                ...
                for (U = 0; L + 1 > U; U++) N = u.apply(0, B.concat(U / L)), ha.push({
                  x: N.x,
                  y: N.y,
                  t: U / L
                });
                  ...
                  for (aa = 0; L > aa; aa++) {
                    ...
                    b: {
                      ...
                      var V = x.y,
                        ...
                        ja = N.x,
                        ka = N.y;
                      if (!(J(F, P) < W(ba, ja) || W(F, P) > J(ba, ja) || J(V, R) < W(ca, ka) || W(V, R) > J(ca, ka))) {
                        var ea = (F * R - V * P) * (ba - ja) - (F - P) * (ba * ka - ca * ja),
                          fa = (F * R - V * P) * (ca - ka) - (V - R) * (ba * ka - ca * ja),
                        ...
                        if (la) {
                          var ea = ea / la,
                            ...
                            la = +ea.toFixed(2),
                            qa = +fa.toFixed(2);
                          if (!(la < +W(F, P).toFixed(2) || la > +J(F, P).toFixed(2) || la < +W(ba, ja).toFixed(2) || la > +J(ba, ja).toFixed(2) || qa < +W(V, R).toFixed(2) || qa > +J(V, R).toFixed(2) || qa < +W(ca, ka).toFixed(2) || qa > +J(ca, ka).toFixed(2))) {
                            F = {
                              x: ea,
                              y: fa
                            };
                    ...
                    F && K[F.x.toFixed(4)] != F.y.toFixed(4) && (K[F.x.toFixed(4)] = F.y.toFixed(4), x = x.t + Y((F[X] - x[X]) / (M[X] - x[X])) * (M.t - x.t), B = B.t + Y((F[O] - B[O]) / (N[O] - B[O])) * (N.t - B.t), 0 <= x && 1 >= x && 0 <= B && 1 >= B && (C ? z++ : z.push({
                      x: F.x,
                      y: F.y,
                      t1: x,
                      t2: B
              ...
              if (c) w += C;
                ...
                D = 0;
                for (L = C.length; L > D; D++) C[D].segment1 = I, C[D].segment2 = S, C[D].bez1 = q, C[D].bez2 = t;
                w = w.concat(C)
              }
            }
          }
    ...
    function L(a) {
      ...
      if (!a) return e();
      a = G(a);
      for (var c, f = 0, h = 0, m = [], p = [], q = 0, y = a.length; y > q; q++)(c = a[q], "M" == c[0]) ? (f = c[1], h = c[2], m.push(f), p.push(h)) : (f = N(f, h, c[1], c[2], c[3], c[4], c[5], c[6]), m = m.concat(f.min.x, f.max.x), p = p.concat(f.min.y, f.max.y), f = c[5], h = c[6]);
      a = W.apply(0, m);
      c = W.apply(0, p);
      m = J.apply(0, m);
      p = J.apply(0, p);
    ...
    function I(b) {
      ...
      if (ha(b, "array") && ha(b && b[0], "array") || (b = a.parsePathString(b)), !b || !b.length) return [
        ["M", 0, 0]
      ];
      var f, e = [],
        k = 0,
        ...
        r = 0,
        y = 0;
      "M" == b[0][0] && (k = +b[0][1], q = +b[0][2], t = k, r = q, y++, e[0] = ["M", k, q]);
      for (var w, G = 3 == b.length && "M" == b[0][0] && "R" == b[1][0].toUpperCase() && "Z" == b[2][0].toUpperCase(), I = y, u = b.length; u > I; I++) {
        if (e.push(y = []), w = b[I], f = w[0], f != f.toUpperCase()) switch (y[0] = f.toUpperCase(), y[0]) {
            case "A":
              y[1] = w[1];
              y[2] = w[2];
              y[3] = w[3];
            ...
            case "H":
              ...
              break;
            case "R":
              for (var v = [k, q].concat(w.slice(1)), C = 2, B = v.length; B > C; C++) v[C] = +v[C] + k, v[++C] = +v[C] + q;
              e.pop();
              e = e.concat(S(v, G));
              break;
            case "O":
            ...
            case "M":
              t = +w[1] + k, r = +w[2] + q;
            default:
              for (C = 1, B = w.length; B > C; C++) y[C] = +w[C] + (C % 2 ? k : q)
          } else if ("R" == f) v = [k, q].concat(w.slice(1)), e.pop(), e = e.concat(S(v, G)), y = ["R"].concat(w.slice(-2));
          else if ("O" == f) e.pop(), v = K(k, q, w[1], w[2]), v.push(v[0]), e = e.concat(v);
        else if ("U" == f) e.pop(), e = e.concat(K(k, q, w[1], w[2], w[3])), y = ["U"].concat(e[e.length - 1].slice(-2));
        else
          for (v = 0, C = w.length; C > v; v++) y[v] = w[v];
        if (f = f.toUpperCase(), "O" != f) switch (y[0]) {
          case "Z":
            k = t;
            q = r;
            break;
    ...
    function T(a, b, c, d, f, e) {
      var k = 1 / 3,
        h = 2 / 3;
      return [k * a + h * c, k * b + h * d, k * f + h * c, k * e + h * d, f, e]
    }
    ...
    function C(b, c, d, f, e, k, h, n, m, p) {
      ...
      if (p) u = p[0], q = p[1], k = p[2], v = p[3];
        ...
        var v = d * d,
          I = f * f,
          v = (k == h ? -1 : 1) * D.sqrt(Y((v * I - v * u * u - I * q * q) / (v * u * u + I * q * q)));
        k = v * d * u / f + (b + n) / 2;
        var v = v * -f * q / d + (c + m) / 2,
      ...
      c = [n + d * q, m - k * h];
      n = [n, m];
      if (b[0] = 2 * f[0] - b[0], b[1] = 2 * f[1] - b[1], p) return [b, c, n].concat(r);
      r = [b, c, n].concat(r).join().split(",");
      p = [];
      n = 0;
      for (m = r.length; m > n; n++) p[n] = n % 2 ? G(r[n - 1], r[n], w).y : G(r[n], r[n + 1], w).x;
      return p
    }
    ...
    function X(a, b, c, d, f, e, k, n, h) {
      var m = 1 - h;
      return {
        x: V(m, 3) * a + 3 * V(m, 2) * h * c + 3 * m * h * h * f + V(h, 3) * k,
        y: V(m, 3) * b + 3 * V(m, 2) * h * d + 3 * m * h * h * e + V(h, 3) * n
      }
    }

    function N(a, b, c, d, f, e, k, h) {
      var n, m = f - 2 * c + a - (k - 2 * f + c),
        q = 2 * (c - a) - 2 * (f - c),
        p = a - c,
        ...
        r = [b, h],
        v = [a, k];
      return "1e12" < Y(t) && (t = .5), "1e12" < Y(w) && (w = .5), 0 < t && 1 > t && (n = X(a, b, c, d, f, e, k, h, t), v.push(n.x), r.push(n.y)), 0 < w && 1 > w && (n = X(a, b, c, d, f, e, k, h, w), v.push(n.x), r.push(n.y)), m = e - 2 * d + b - (h - 2 * e + d), q = 2 * (d - b) - 2 * (e - d), p = b - d, t = (-q + D.sqrt(q * q - 4 * m * p)) / 2 / m, w = (-q - D.sqrt(q * q - 4 * m * p)) / 2 / m, "1e12" < Y(t) && (t = .5), "1e12" < Y(w) && (w = .5), 0 < t && 1 > t && (n = X(a, b, c, d, f, e, k, h, t), v.push(n.x), r.push(n.y)), 0 < w && 1 > w && (n = X(a, b, c, d, f, e, k, h, w), v.push(n.x), r.push(n.y)), {
        min: {
          x: W.apply(0, v),
          y: W.apply(0, r)
        },
    ...
    function G(a, b) {
      ...
      var f = I(a),
        ...
        t = function (a, b, c, d, l) {
          a && b && "M" == a[l][0] && "M" != b[l][0] && (b.splice(l, 0, ["M", d.x, d.y]), c.bx = 0, c.by = 0, c.x = a[l][1], c.y = a[l][2], v = J(f.length, e && e.length || 0))
        },
        r = 0,
        v = J(f.length, e && e.length || 0);
      for (; v > r; r++) {
    ...
    a.path.toRelative = function (b) {
      ...
      var e = [],
        ...
        w = 0,
        r = 0;
      "M" == b[0][0] && (k = b[0][1], q = b[0][2], t = k, w = q, r++, e.push(["M", k, q]));
      for (var v = b.length; v > r; r++) {
        var u = e[r] = [],
          G = b[r];
        if (G[0] != f.call(G[0])) switch (u[0] = f.call(G[0]), u[0]) {
          case "a":
            u[1] = G[1];
            u[2] = G[2];
            u[3] = G[3];
          ...
          case "m":
            t = G[1], w = G[2];
          default:
            for (var I = 1, C = G.length; C > I; I++) u[I] = +(G[I] - (I % 2 ? k : q)).toFixed(3)
        } else
          for (e[r] = [], "m" == G[0] && (t = G[1] + k, w = G[2] + q), u = 0, I = G.length; I > u; u++) e[r][u] = G[u];
        G = e[r].length;
        switch (e[r][0]) {
          case "z":
            k = t;
    ...
    a.path.map = function (a, b) {
      ...
      for (k = a.length; k > f; f++)
        for (n = a[f], e = 1, h = n.length; h > e; e += 2) c = b.x(n[e], n[e + 1]), d = b.y(n[e], n[e + 1]), n[e] = c, n[e + 1] = d;
      return a
    };
    a.path.toString = h;
    a.path.clone = m
    ...
    h.splice = function (a, f) {
      ...
      var E = B.length;
      for (h = 0; h < E + p.length; h++) this.items[a + h] = this[a + h] = E > h ? B[h] : p[h - E];
      for (h = this.items.length = this.length -= f - E; this[h];) delete this[h++];
      return new e(H)
    };
    ...
    h.getBBox = function () {
      for (var a = [], f = [], e = [], k = [], h = this.items.length; h--;)
        if (!this.items[h].removed) {
          ...
          e.push(p.x + p.width);
          k.push(p.y + p.height)
        } return a = d.apply(0, a), f = d.apply(0, f), e = b.apply(0, e), k = b.apply(0, k), {
        x: a,
        y: f,
        x2: e,
        y2: k,
    ...
    function e(b, c, f) {
      ...
      for (var k, h, m, p, B = Math.max(b.length, c.length), C = [], H = [], N = 0; B > N; N++) {
        if (m = b[N] || d(c[N]), p = c[N] || d(m), m[0] != p[0] || "r" == m[0].toLowerCase() && (m[2] != p[2] || m[3] != p[3]) || "s" == m[0].toLowerCase() && (m[3] != p[3] || m[4] != p[4])) {
        ...
        H[N] = [];
        k = 0;
        for (h = Math.max(m.length, p.length); h > k; k++) k in m && (C[N][k] = m[k]), k in p && (H[N][k] = p[k])
      }
      return {
        from: u(C),
        to: u(H),
    ...
    b.prototype.equal = function (b, c) {
      ...
      if ("colour" == H[b]) return d = a.color(K), n = a.color(c), {
        from: [d.r, d.g, d.b, d.opacity],
        to: [n.r, n.g, n.b, n.opacity],
        f: f
      };
      if ("transform" == b || "gradientTransform" == b || "patternTransform" == b) return c instanceof a.Matrix && (c = c.toTransformString()), a._.rgTransform.test(c) || (c = a._.svgTransform2string(c)), e(K, c, function () {
        return I.getBBox(1)
      });
      if ("d" == b || "path" == b) return d = a.path.toCubic(K, c), {
        from: u(d[0]),
        to: u(d[1]),
        f: q(d[0])
      };
      if ("points" == b) return d = E(K).split(","), n = E(c).split(","), {
        from: d,
        to: n,
        f: function (a) {
          return a
    ...
    var f = {
      ...
      r = function () {
        return e.doc.addEventListener ? function (a, b, c, d) {
          var e = m && f[b] ? f[b] : b,
            k = function (e) {
              ...
              if (m && f.hasOwnProperty(b))
                for (var n = 0, p = e.targetTouches && e.targetTouches.length; p > n; n++)
          ...
          return b !== e && a.addEventListener(b, k, !1), a.addEventListener(e, k, !1),
            function () {
              return b !== e && a.removeEventListener(b, k, !1), a.removeEventListener(e, k, !1), !0
            }
          ...
          var f = function (a) {
            ...
            var b = q("y"),
              ...
              f = a.clientX + f,
              b = a.clientY + b;
            return a.preventDefault = a.preventDefault || u, a.stopPropagation = a.stopPropagation || B, c.call(d, a, f, b)
          };
      ...
      t = [],
      L = function (b) {
        for (var c, d = b.clientX, f = b.clientY, e = q("y"), k = q("x"), n = t.length; n--;) {
          if (c = t[n], m)
            for (var p, u = b.touches && b.touches.length; u--;) {
              if (p = b.touches[u], p.identifier == c.el._drag.id || c.el.node.contains(p.target)) {
                d = p.clientX;
                f = p.clientY;
          ...
          d += k;
          f += e;
          h("snap.drag.move." + c.el.id, c.move_scope || c.el, d - c.el._drag.x, f - c.el._drag.y, d, f, b)
        }
      },
      v = function (b) {
        a.unmousemove(L).unmouseup(v);
        for (var c, d = t.length; d--;) c = t[d], c.el._drag = {}, h("snap.drag.end." + c.el.id, c.end_scope || c.start_scope || c.move_scope || c.el, b);
        t = []
      };
    ...
    p.drag = function (b, c, d, f, e, k) {
      ...
      if (!arguments.length) {
        ...
        return this.drag(function (a, b) {
          this.attr({
            transform: p + (p ? "T" : "t") + [a, b]
          })
        }, function () {
          p = this.transform().local
        })
      }
      return this._drag = {}, K.push({
        el: this,
        start: n
      }), this.mousedown(n), this
    };
    p.undrag = function () {
      for (var b = K.length; b--;) K[b].el == this && (this.unmousedown(K[b].start), K.splice(b, 1), h.unbind("snap.drag.*." + this.id));
    ...
    d.filter = function (d) {
      ...
      }), h.appendChild(d.node), e.defs.appendChild(h), new b(h)
    };
...
! function (e) {
  ...
  b.prototype._init = function () {
    ...
    if (this.openingSteps = b ? b.split(";") : "", this.openingStepsTotal = b ? this.openingSteps.length : 0, 0 !== this.openingStepsTotal) this.closingSteps = (b = this.el.getAttribute("data-closing") ? this.el.getAttribute("data-closing") : this.initialPath) ? b.split(";") : "", this.closingStepsTotal = b ? this.closingSteps.length : 0, this.isAnimating = !1, this.options.speedOut || (this.options.speedOut = this.options.speedIn), this.options.easingOut || (this.options.easingOut = this.options.easingIn)
  };
  ...
  b.prototype._animateSVG = function (b, a) {
    var c = this,
      ...
      f = function (b) {
        return b > k - 1 ? (a && "function" == typeof a && a(), void 0) : (c.path.animate({
          path: e[b]
        }, h, m, function () {
          f(b)
        }), b++, void 0)
...
! function () {
  function e(b, a) {
    var c = [],
      e = this.options;
    return e.onProgress && b && e.onProgress.call(this, b, a, this.completed.length), this.completed.length + this.errors.length === this.queue.length && (c.push(this.completed), this.errors.length && c.push(this.errors), e.onComplete.apply(this, c)), this
  }
  ...
  b.prototype._addEvents = function (b, a, c) {
    var n = this,
      k = this.options,
      p = function () {
        h ? (this.removeEventListener("error", m), this.removeEventListener("abort", m), this.removeEventListener("load", f)) : this.onerror = this.onabort = this.onload = null
      },
      m = function () {
        p.call(this);
        n.errors.push(a);
    ...
    return h ? (b.addEventListener("error", m, !1), b.addEventListener("abort", m, !1), b.addEventListener("load", f, !1)) : (b.onerror = b.onabort = m, b.onload = f), this
  };
...
! function (e, h) {
  ...
  e.MixItUp.prototype = {
    ...
    _platformDetect: function () {
      var b = ["Webkit", "Moz", "O", "ms"],
        ...
        e = function (a) {
          for (var c = 0; c < b.length; c++)
            if (b[c] + "Transition" in a.style) return {
              prefix: "-" + b[c].toLowerCase() + "-",
              vendor: b[c]
            };
      ...
      this._ff = c ? parseInt(window.navigator.userAgent.match(/rv:([^)]+)\)/)[1]) : !1;
      this._prefix = e.prefix;
      this._vendor = e.vendor;
      (this._suckMode = window.atob && this._prefix ? !1 : !0) && (this.animation.enable = !1);
      this._ff && 4 >= this._ff && (this.animation.enable = !1);
      for (a = 0; a < d.length && !window.requestAnimationFrame; a++) window.requestAnimationFrame = window[d[a] + "RequestAnimationFrame"];
      "function" != typeof Object.getPrototypeOf && (Object.getPrototypeOf = "object" == typeof "test".__proto__ ? function (a) {
        return a.__proto__
      } : function (a) {
        return a.constructor.prototype
      });
      this._domNode.nextElementSibling === h && Object.defineProperty(Element.prototype, "nextElementSibling", {
        get: function () {
        ...
        if (c.dataset === h || d) {
          ...
          for (var e = 0; e < c.attributes.length; e++) {
            var k = c.attributes[e],
              p = k.name,
              k = k.value; - 1 < p.indexOf("data-") && (p = this._helpers._camelCase(p.substring(5, p.length)), c.dataset[p] = k)
          }
        }
        c.mixParent === h && (c.mixParent = this._id)
      }
      if (this._$targets.length && b || !this._origOrder.length && this._$targets.length)
        for (this._origOrder = [], a = 0; a < this._$targets.length; a++) c = this._$targets[a], this._origOrder.push(c);
    ...
    _bindHandlers: function () {
      ...
      b.controls.live ? b._$body.on("click.mixItUp." + b._id, b.selectors.sort, function () {
        b._processClick(e(this), "sort")
      }).on("click.mixItUp." + b._id, b.selectors.filter, function () {
        b._processClick(e(this), "filter")
      }) : (b._$sortButtons = e(b.selectors.sort), b._$filterButtons = e(b.selectors.filter), b._$sortButtons.on("click.mixItUp." + b._id, function () {
        b._processClick(e(this), "sort")
      }), b._$filterButtons.on("click.mixItUp." + b._id, function () {
        b._processClick(e(this), "filter")
      }));
      d[b.selectors.filter] = d[b.selectors.filter] === h ? 1 : d[b.selectors.filter] + 1;
      a[b.selectors.sort] = a[b.selectors.sort] === h ? 1 : a[b.selectors.sort] + 1;
    ...
    _processClick: function (b, d) {
      var a = this,
        c = function (b, c, d) {
          ...
          k._handled["_" + c][a.selectors[c]] = k._handled["_" + c][a.selectors[c]] === h ? 1 : k._handled["_" + c][a.selectors[c]] + 1;
          k._handled["_" + c][a.selectors[c]] === k._bound["_" + c][a.selectors[c]] && (b[(d ? "remove" : "add") + "Class"](a.controls.activeClass), delete k._handled["_" + c][a.selectors[c]])
        };
      if (a._execAction("_processClick", 0, arguments), !a._mixing || a.animation.queue && a._queue.length < a.animation.queueLimit) {
        if (a._clicking = !0, "sort" === d) {
          ...
          (!b.hasClass(a.controls.activeClass) || -1 < n.indexOf("random")) && (e(a.selectors.sort).removeClass(a.controls.activeClass), c(b, d), a.sort(n))
        }
        if ("filter" === d) {
          var k, n = b.attr("data-filter"),
            p = "or" === a.controls.toggleLogic ? "," : "";
          a.controls.toggleFilterButtons ? (a._buildToggleArray(), b.hasClass(a.controls.activeClass) ? (c(b, d, !0), k = a._toggleArray.indexOf(n), a._toggleArray.splice(k, 1)) : (c(b, d), a._toggleArray.push(n)), a._toggleArray = e.grep(a._toggleArray, function (a) {
            return a
          }), a._toggleString = a._toggleArray.join(p), a.filter(a._toggleString)) : b.hasClass(a.controls.activeClass) || (e(a.selectors.filter).removeClass(a.controls.activeClass), c(b, d), a.filter(n))
        }
    ...
    _buildToggleArray: function () {
      ...
      if (this._execAction("_buildToggleArray", 0, arguments), "or" === this.controls.toggleLogic) this._toggleArray = b.split(",");
      else {
        this._toggleArray = b.split(".");
        !this._toggleArray[0] && this._toggleArray.shift();
        for (var d = 0; b = this._toggleArray[d]; d++) this._toggleArray[d] = "." + b
      }
    ...
    _updateControls: function (b, d) {
      ...
      for (var k = 0; 2 > k; k++) {
        if (n = this.controls.live ? e(this.selectors[c]) : this["_$" + c + "Buttons"]) {
          var p = "[data-" + c + '="' + a[c] + '"]';
          d && "filter" == c && "none" !== a.filter && "" !== a.filter ? n.filter(p).addClass(this.controls.activeClass) : n.removeClass(this.controls.activeClass).filter(p).addClass(this.controls.activeClass)
        }
        c = "sort"
      }
    ...
    _filter: function () {
      ...
      for (var b = 0; b < this._$targets.length; b++) {
        ...
        d.is(this._activeFilter) ? this._$show = this._$show.add(d) : this._$hide = this._$hide.add(d)
      }
    ...
    _sort: function () {
      ...
      b._startOrder = [];
      for (var a = 0; a < b._$targets.length; a++) b._startOrder.push(b._$targets[a]);
    ...
    _compare: function (b, d, a) {
      ...
      return k > h ? "asc" == e ? -1 : 1 : h > k ? "asc" == e ? 1 : -1 : h == k && c._newSort.length > a + 1 ? c._compare(b, d, a + 1) : 0
    },
    _printSort: function (b) {
      ...
      for (var k = 0; k < a.length; k++) {
        var h = a[k],
          m = h.nextSibling;
        "absolute" !== h.style.position && (m && "#text" == m.nodeName && this._$parent[0].removeChild(m), this._$parent[0].removeChild(h))
      }
      for (k = 0; k < d.length; k++) a = d[k], "default" != this._newSort[0].sortBy || "desc" != this._newSort[0].order || b ? (e.appendChild(a), e.appendChild(document.createTextNode(" "))) : (e.insertBefore(a, e.firstChild), e.insertBefore(document.createTextNode(" "), a));
    ...
    _parseSort: function (b) {
      for (var d = "string" == typeof b ? b.split(" ") : [b], a = [], c = 0; c < d.length; c++) {
        var e = "string" == typeof b ? d[c].split(":") : ["custom", d[c]],
          e = {
            sortBy: this._helpers._camelCase(e[0]),
            order: e[1] || "asc"
          };
        ...
        a = function (a, c) {
          if (-1 < b.animation.effects.indexOf(a)) {
            if (c) {
              ...
              if (-1 < d) return d = b.animation.effects.substring(d), {
                val: /\(([^)]+)\)/.exec(d)[1]
              }
            }
            return !0
        ...
        c = function (b, c) {
          for (var e = [
            ...
            var f = e[h][0],
              ...
              H = d[b],
              B;
            a(f) ? (B = f + "(", f = a(f, !0).val || q, u = u ? "-" === f.charAt(0) ? f.substr(1, f.length) : "-" + f : f, B = B + u + ") ") : B = "";
            d[b] = H + B
          }
        };
      return d.opacity = a("fade") ? a("fade", !0).val || "0" : "1", c("transformIn"), b.animation.reverseOut ? c("transformOut", !0) : d.transformOut = d.transformIn, d.transition = {}, d.transition = b._getPrefixedCSS("transition", "all " + b.animation.duration + "ms " + b.animation.easing + ", opacity " + b.animation.duration + "ms linear"), b.animation.stagger = a("stagger") ? !0 : !1, b.animation.staggerDuration = parseInt(a("stagger") && a("stagger", !0).val ? a("stagger", !0).val : 100), b._execFilter("_parseEffects", d)
    },
    _buildState: function (b) {
      var d = {};
      return this._execAction("_buildState", 0), d = {
        activeFilter: "" === this._activeFilter ? "none" : this._activeFilter,
        activeSort: b && this._newSortString ? this._newSortString : this._activeSort,
        ...
        display: b && this._newDisplay ? this._newDisplay : this.layout.display
      }, b ? this._execFilter("_buildState", d) : (this._state = d, void this._execAction("_buildState", 1))
    },
    _goMix: function (b) {
      var d = this,
        a = function () {
      ...
      "function" == typeof d.callbacks.onMixStart && d.callbacks.onMixStart.call(d._domNode, d._state, h, d);
      d._$container.trigger("mixStart", [d._state, h, d]);
      d._getOrigMixData();
      b && !d._suckMode ? window.requestAnimationFrame ? requestAnimationFrame(a) : a() : d._cleanUp();
    ...
    _getTargetData: function (b, d) {
      ...
      this.animation.animateResizeTargets && (a = window.getComputedStyle(b), b.dataset[d + "MarginBottom"] = parseInt(a.marginBottom), b.dataset[d + "MarginRight"] = parseInt(a.marginRight), b.dataset[d + "Width"] = b.offsetWidth, b.dataset[d + "Height"] = b.offsetHeight)
    },
    _getOrigMixData: function () {
      var b = this._suckMode ? {
        boxSizing: ""
      } : window.getComputedStyle(this._$parent[0]);
      this._incPadding = "border-box" === (b.boxSizing || b[this._vendor + "BoxSizing"]);
      ...
      for (b = 0; b < this._$pre.length; b++) this._getTargetData(this._$pre[b], "orig");
      this._execAction("_getOrigMixData", 1)
    },
    _setInter: function () {
      this._execAction("_setInter", 0);
      this._changingLayout && this.animation.animateChangeLayout ? (this._$toShow.css("display", this._newDisplay), this._changingClass && this._$container.removeClass(this.layout.containerClass).addClass(this._newClass)) : this._$toShow.css("display", this.layout.display);
    ...
    _getInterMixData: function () {
      ...
      for (b = 0; b < this._$pre.length; b++) d = this._$pre[b], this._getTargetData(d, "inter");
    ...
    _getFinalMixData: function () {
      ...
      for (b = 0; b < this._$pre.length; b++) d = this._$pre[b], this._getTargetData(d, "final");
    ...
    _animateTargets: function () {
      ...
      for (var a = 0; a < this._$toShow.length; a++) {
        ...
        for (c = 0; 2 > c; c++) {
          ...
          this._ff && 20 >= this._ff && (p[m + "transition-property"] = "all", p[m + "transition-timing-function"] = this.animation.easing + "ms", p[m + "transition-duration"] = this.animation.duration + "ms");
          p[m + "transition-delay"] = k + "ms";
          p[m + "transform"] = "translate(" + b + "px," + d + "px)"
        }(this.effects.transform || this.effects.opacity) && this._bindTargetDone(h);
        this._ff && 20 >= this._ff ? h.css(p) : h.css(this.effects.transition).css(p)
      }
      for (a = 0; a < this._$pre.length; a++) c = this._$pre[a], h = e(c), b = c.dataset.finalPosX - c.dataset.interPosX, d = c.dataset.finalPosY - c.dataset.interPosY, k = this._getDelay(a), c.dataset.finalPosX === c.dataset.origPosX && c.dataset.finalPosY === c.dataset.origPosY || this._bindTargetDone(h), h.css(this._getPrefixedCSS("transition", "all " + this.animation.duration + "ms " + this.animation.easing + " " + k + "ms")), h.css(this._getPrefixedCSS("transform", "translate(" + b + "px," + d + "px)")), this.animation.animateResizeTargets && (c.dataset.origWidth - c.dataset.finalWidth && 1 * c.dataset.finalWidth && (c.style.width = c.dataset.finalWidth + "px", c.style.marginRight = -(c.dataset.finalWidth - c.dataset.interWidth) + 1 * c.dataset.finalMarginRight + "px"), c.dataset.origHeight - c.dataset.finalHeight && 1 * c.dataset.finalHeight && (c.style.height = c.dataset.finalHeight + "px", c.style.marginBottom = -(c.dataset.finalHeight - c.dataset.interHeight) + 1 * c.dataset.finalMarginBottom + "px"));
      ...
      for (a = 0; a < this._$toHide.length; a++) {
        ...
        k = this._getDelay(a);
        b = {};
        for (c = 0; 2 > c; c++) m = 0 === c ? m = this._prefix : "", b[m + "transition-delay"] = k + "ms", b[m + "transform"] = this.effects.transformOut, b.opacity = this.effects.opacity;
    ...
    _bindTargetDone: function (b) {
      ...
      a.dataset.bound || (a.dataset.bound = !0, d._targetsBound++, b.on("webkitTransitionEnd.mixItUp transitionend.mixItUp", function (c) {
        (-1 < c.originalEvent.propertyName.indexOf("transform") || -1 < c.originalEvent.propertyName.indexOf("opacity")) && e(c.originalEvent.target).is(d.selectors.target) && (b.off(".mixItUp"), delete a.dataset.bound, d._targetDone())
      }));
    ...
    _cleanUp: function () {
      var b = this,
        d = b.animation.animateResizeTargets ? "transform opacity width height margin-bottom margin-right" : "transform opacity";
      unBrake = function () {
    ...
    _getDelay: function (b) {
      var d = "function" == typeof this.animation.staggerSequence ? this.animation.staggerSequence.call(this._domNode, b, this._state) : b;
      return this._execFilter("_getDelay", this.animation.stagger ? d * this.animation.staggerDuration : 0, arguments)
    },
    _parseMultiMixArgs: function (b) {
      for (var d = {
        ...
        var c = b[a];
        null !== c && ("object" == typeof c || "string" == typeof c ? d.command = c : "boolean" == typeof c ? d.animate = c : "function" == typeof c && (d.callback = c))
      }
    ...
    _parseInsertArgs: function (b) {
      for (var d = {
        ...
        var c = b[a];
        "number" == typeof c ? d.index = c : "object" == typeof c && c instanceof e ? d.$object = c : "object" == typeof c && this._helpers._isElement(c) ? d.$object = e(c) : "object" == typeof c && null !== c ? d.multiMix = c : "boolean" != typeof c || c ? "function" == typeof c && (d.callback = c) : d.multiMix = !1
      }
    ...
    _execFilter: function (b, d, a) {
      if (this._filters.isEmptyObject || !this._filters.hasOwnProperty(b)) return d;
    ...
    _helpers: {
      ...
      _isElement: function (b) {
        return window.HTMLElement ? b instanceof HTMLElement : null !== b && 1 === b.nodeType && "string" === b.nodeName
      }
    },
    isMixing: function () {
    ...
    multiMix: function () {
      var b = this._parseMultiMixArgs(arguments);
      if (this._execAction("multiMix", 0, arguments), this._mixing) this.animation.queue && this._queue.length < this.animation.queueLimit ? (this._queue.push(arguments), this.controls.enable && !this._clicking && this._updateControls(b.command), this._execAction("multiMixQueue", 1, arguments)) : ("function" == typeof this.callbacks.onMixBusy && this.callbacks.onMixBusy.call(this._domNode, this._state, this), this._$container.trigger("mixBusy", [this._state, this]), this._execAction("multiMixBusy", 1, arguments));
      else {
        this.controls.enable && !this._clicking && (this.controls.toggleFilterButtons && this._buildToggleArray(), this._updateControls(b.command, this.controls.toggleFilterButtons));
        ...
        this._refresh();
        d && (this._newSort = this._parseSort(d), this._newSortString = d, this._sorting = !0, this._sort());
        a !== h && (a = "all" === a ? this.selectors.target : a, this._activeFilter = a);
        this._filter();
        ...
        this._$targets.css(this._brake);
        this._goMix(b.animate ^ this.animation.enable ? b.animate : this.animation.enable);
    ...
    insert: function () {
      var b = this._parseInsertArgs(arguments),
        ...
        c = (this._refresh(), this._$targets.length ? b.index < this._$targets.length || !this._$targets.length ? this._$targets[b.index] : this._$targets[this._$targets.length - 1].nextElementSibling : this._$parent[0].children[0]);
      if (this._execAction("insert", 0, arguments), b.$object) {
        for (var e = 0; e < b.$object.length; e++) a.appendChild(b.$object[e]), a.appendChild(document.createTextNode(" "));
    ...
    getOption: function (b) {
      var d = function (a, b) {
        for (var d = b.split("."), e = d.pop(), p = d.length, m = 1, f = d[0] || b;
          (a = a[f]) && p > m;) f = d[m], m++;
    ...
    destroy: function (b) {
      ...
      this._$body.add(e(this.selectors.sort)).add(e(this.selectors.filter)).off(".mixItUp");
  ...
  e.fn.mixItUp = function () {
    var b, d = arguments,
      ...
      c = function (a, b) {
        ...
        a.id = a.id ? a.id : "MixItUp" + ("00000" + (16777216 * Math.random() << 0).toString(16)).substr(-6).toUpperCase();
    ...
    return b = this.each(function () {
      if (d && "string" == typeof d[0]) {
        ...
        "isLoaded" == d[0] ? a.push(b ? !0 : !1) : (b = b[d[0]](d[1], d[2], d[3]), b !== h && a.push(b))
      } else c(this, d[0])
  ...
  e.fn.removeStyle = function (b, d) {
    return d = d ? d : "", this.each(function () {
      for (var a = b.split(" "), c = 0; c < a.length; c++)
        for (var e = 0; 2 > e; e++) {
          var k = e ? a[c] : d + a[c];
          if (this.style[k] !== h && "unknown" != typeof this.style[k] && 0 < this.style[k].length && (this.style[k] = ""), !d) break
        }
      this.attributes && this.attributes.style && this.attributes.style !== h && "" === this.attributes.style.value && this.attributes.removeNamedItem("style")
    })
  }
}(jQuery);
! function (e) {
